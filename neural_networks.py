...
def prepare_data_oneliner():
    ...
    data_train = pd.read_csv("Sprungdaten_processed/percentage/5/vector_percentage_mean_5_train.csv")
    data_test = pd.read_csv("Sprungdaten_processed/percentage/5/vector_percentage_mean_5_test.csv")
...
def run_multiple_times_oneliner(runs, num_columns, act_func, loss, optim, x_train, y_train, x_test, y_test, epochs):
...
def main():
    ...
    # model = run_multiple_times(3, jump_data_length, num_columns, 1, 3, 2, 2, 'tanh', 'categorical_crossentropy', 'adam', x_train, y_train, x_test, y_test, 50)

    model = run_multiple_times_oneliner(10, num_columns, 'tanh', 'kl_divergence', 'adam', x_train, y_train, x_test, y_test, 60)
