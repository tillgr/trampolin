...
if __name__ == '__main__':
    ...
    for i in [1, 2, 5, 10, 20, 25]:
        for calc_type in ['', 'mean_', 'mean_std_']:
            ...
            train_merged = pd.read_csv("../Sprungdaten_processed/percentage/" + str(i) + "/vector_percentage_" + calc_type + str(i) + "_train.csv")
            test_merged = pd.read_csv("../Sprungdaten_processed/percentage/" + str(i) + "/vector_percentage_" + calc_type + str(i) + "_test.csv")
