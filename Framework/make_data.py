...
def create_all_data():
    ...
    for p in ['with_preprocessed', 'without_preprocessed']:
        ...
        for n in ['percentage_mean_std', 'percentage_mean', 'percentage']:
            process_data.vectorize_data(p, n, ['25', '20', '10', '5', '2', '1'])
    for p in ['with_preprocessed', 'without_preprocessed']:
...
def create_used_data():
    ...
    for p in ['with_preprocessed', 'without_preprocessed']:
        for m in [None, 'mean', 'mean_std']:
            ...
            pass
        for n in ['percentage_mean_std', 'percentage_mean', 'percentage']:
            process_data.vectorize_data(p, n, ['25', '20', '10', '5'])
...
if __name__ == '__main__':
    ...
    print("Do you want to create all data? To only create used data type 'n'. [y/n]")
    x = input()
    ...
    print("Finished creating the data.")
